...
class VolumeEncoder(BaseNetwork):
    """CycleGan Encoder"""
    def __init__(self, num_in=3, num_out=32,num_inter=8):
...
class VolumeEncoder1(BaseNetwork):
    """CycleGan Encoder"""
    def __init__(self, num_in=3, num_out=32,num_inter = 16):
        super(VolumeEncoder1, self).__init__()
        self.num_in = num_in
        self.num_out = num_out
        self.num_inter = num_inter
        self.relu = nn.ReLU(inplace=True)
